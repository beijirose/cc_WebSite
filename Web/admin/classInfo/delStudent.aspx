<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delStudent.aspx.cs" Inherits="classInfo_delStudent" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>班级管理-删除学员</title>
...
<body>
    ...
    <div id="topBar"><img src="../images/ico_home.gif" width="17" height="17"/>班级管理&nbsp;<span>>&nbsp;删除学员</span></div>
<div id="main">
<div class="bar">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        jQuery("#gridTable").jqGrid({
            url: 'delStudent.ashx?id=' + api.data, //地址文件
            datatype: "json",
    ...
    $(".btn_azul").click(function () {
        $("#gridTable").jqGrid("setGridParam", {
            ...
            postData: eval("({'name':'" + $("#name").val() + "','flag':'del','id':'" + api.data + "'})") //发送数据 
        }).trigger("reloadGrid");
    });
