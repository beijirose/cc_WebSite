...
a.p.pager="#"+b(a.p.pager).attr("id"),b(a.p.pager).css({width:c.width+"px"}).appendTo(n).addClass("ui-state-default1 ui-jqgrid-pager ui-corner-bottom"),C&&b(a.p.pager).hide(),m(a.p.pager,""));!1===a.p.cellEdit&&!0===a.p.hoverrows&&b(a).bind("mouseover",function(a){l=b(a.target).closest("tr.jqgrow");b(l).attr("class")!=="ui-subgrid"&&b(l).addClass("ui-state-hover1")}).bind("mouseout",function(a){l=b(a.target).closest("tr.jqgrow");b(l).removeClass("ui-state-hover1")});var s,E,ha;b(a).before(c.hDiv).click(function(c){z=
