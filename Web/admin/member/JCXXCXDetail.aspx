<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JCXXCXDetail.aspx.cs" Inherits="admin_member_JCXXCXDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $.ajax({
                type: 'Post',
                async: false,
                url: 'JCXXCXDetail.aspx/load',
                data: "{'id':'" + api.data + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function(msg) {
                jQuery("#gridTable").jqGrid({
                url: 'JCXXCXDetailList.ashx?id=' + api.data, //地址文件
                        datatype: "json",
                        colNames: ['ID', '加油枪编号', '加油枪序号', '稽查日期', '稽查月数', '所属年月', '油量(升)', '金额(元)', '一致标志'],
                        colModel: [
                { name: 'id', index: 'id', width: 30, hidden: true },
                { name: 'yqbh', index: 'yqbh', width: 100, align: "center" },
                { name: 'yqxh', index: 'yqxh', width: 100, align: "center" },
                { name: 'jcrq', index: 'jcrq', width: 100, align: "center" },
                { name: 'jczys', index: 'jczys', width: 100, align: "center" },
                { name: 'ny', index: 'ny', width: 100, align: "center" },
                { name: 'yl', index: 'yl', width: 100, align: "left" },
                { name: 'je', index: 'je', width: 100, align: "center" },   
                { name: 'yzbz', index: 'yzbz', width: 100, align: "center" }
                         ],
                width: 800,
                height: 450,
                        rowNum: 15,
