...
<body>
    ...
    <div id="main">
        <div class="bar">
           ...
           <label>
                            加油站编号:</label><input id="jyzbh" name="jyzbh" type="text" class="textinput" style="float: left;" />
            <label>
    ...
    <script type="text/javascript">
        ...
        $(".btn_azul").click(function() {
            $("#gridTable").jqGrid("setGridParam", {
                url: "search.ashx",
                postData: eval("({'jyzmc':'" + $("#jyzmc").val() + "','nssbh':'" + $("#nssbh").val() + "','dz':'" + $("#dz").val() + "','jyzbh':'" + $("#jyzbh").val() + "'})") //发送数据
            }).trigger("reloadGrid");
